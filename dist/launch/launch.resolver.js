...
let LaunchResolver = class LaunchResolver {
...
], LaunchResolver.prototype, "launches", null);
__decorate([
    graphql_1.Query(),
    ...
    __metadata("design:returntype", void 0)
], LaunchResolver.prototype, "launch", null);
LaunchResolver = __decorate([
    graphql_1.Resolver('Launch'),
    __metadata("design:paramtypes", [launch_service_1.LaunchService])
], LaunchResolver);
exports.LaunchResolver = LaunchResolver;
//# sourceMappingURL=launch.resolver.js.map